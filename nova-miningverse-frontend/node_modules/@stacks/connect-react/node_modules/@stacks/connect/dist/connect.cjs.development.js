...
function hasUserSession(userSession) {
  try {
...
function getDefaults(options) {
  ...
  var hasSetRequiredStxAddressPropForRequestAccountFlow = ("stxAddress" in options);

  if (!hasSetRequiredStxAddressPropForRequestAccountFlow) {
    throw new Error("Must set property `stxAddress` when using `stx_requestAccounts to initiate transaction`");
  }
...
function createUnsignedPayload(payload) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            return _context2.abrupt("return", createUnsignedPayload(payload));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 6:
            ...
            if (appDetails) payload.appDetails = appDetails;
            return _context3.abrupt("return", createUnsignedPayload(payload));
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 6:
            ...
            if (appDetails) payload.appDetails = appDetails;
            return _context4.abrupt("return", createUnsignedPayload(payload));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", signPayload$1(payload, privateKey));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            tokenSigner = new jsontokens.TokenSigner("ES256k", privateKey);
            return _context2.abrupt("return", tokenSigner.signAsync(_extends({}, payload, {
              message: transactions.serializeCV(payload.message).toString("hex"),
              domain: transactions.serializeCV(payload.domain).toString("hex")
            })));
